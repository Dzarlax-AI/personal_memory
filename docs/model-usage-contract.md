...
- replace the [Fact Lifecycle Contract](lifecycle.md).
...
The [Fact Lifecycle Contract](lifecycle.md) is normative for states, authority metadata, relationships, expiry, visibility, migration, and rollback.
