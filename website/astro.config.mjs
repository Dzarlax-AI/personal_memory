  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: 'Operations', items: [{ slug: 'operations/upgrade-rollback' }, { slug: 'operations/backups-release' }, { slug: 'operations/troubleshooting' }, { slug: 'operations/evaluation' }, { slug: 'operations/conformance' }] },
